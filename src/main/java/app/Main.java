...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("Please, enter Commands like its written below:");
        ...
        do {
            ...
            if (command.startsWith("add")) {
                ...
                System.out.println("Total expenses in " + params[1] + ": " + formatter.format(res) + " " + params[1]);
